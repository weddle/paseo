...
| [docs/omp-coordination.md](docs/omp-coordination.md)               | OMP agent coordination: the three IRC inbound transports, hub tool rows, why `metadata` over a new detail type                 |
